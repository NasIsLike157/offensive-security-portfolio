...
class Scanner:
    def __init__(self, host):
        ...
        self.socket = socket.socket(socket.AF_INET,socket.SOCK_RAW,socket_proto)
        ...
        try:
            while True : 
                ...
                if ip_header.protocol == 'ICMP':
                    ...
                    # Create buffer for icmp header
                    icmp_header = ICMP(icmp_buf)
                    # Check for right icmp message (type 3 code 3)
...
if __name__ == '__main__':
    ...
    t = threading.Thread(target=spray_udp)
    t.start()
